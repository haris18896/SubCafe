...
export const notificationItems = [
  {
    name: 'Email',
    icon: <Mail width={AppTheme?.WP(10)} height={AppTheme?.WP(10)} />,
  },
];

// **
export const getOfferingDescription = subscriptionType => {
  switch (subscriptionType) {
    case 'One-Time':
      return 'single payment for instant access.';
    case 'Weekly':
      return 'Billed weekly for consistent usage.';
    case 'Monthly':
      return 'Access for a month with recurring billing.';
    case 'Yearly':
      return 'Annual access with cost savings.';
    default:
      return 'Subscription type not recognized.';
  }
};
